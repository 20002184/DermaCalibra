...
def parse_args():
    ...
    parser.add_argument("--data_path", type=str, default="/home/yue/wbwb/VisualMetaGuidedSkinLesionClassification/PAD-UFES-20", help="Path to PAD-UFES-20 dataset")
    parser.add_argument("--output_dir", type=str, default="/home/yue/wbwb/VisualMetaGuidedSkinLesionClassification/result", help="Directory to save results")
